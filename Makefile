...
ifeq ($(DOWNLOAD_URL),0)
  #LINK = https://github.com/fransiskusyoga/tellor_ooc_dcp/releases/download/v1/top_0xbitcoin_routed_square_unplaced.dcp
	LINK = https://github.com/fransiskusyoga/tellor_ooc_dcp/releases/download/v2/top_0xbitcoin_routed_square_unplaced.dcp
else
  #LINK = https://github.com/fransiskusyoga/tellor_ooc_dcp/releases/download/v1/top_0xbitcoin_routed_vert_unplaced.dcp
	LINK = https://github.com/fransiskusyoga/tellor_ooc_dcp/releases/download/v2/top_0xbitcoin_routed_vert_unplaced.dcp
endif
